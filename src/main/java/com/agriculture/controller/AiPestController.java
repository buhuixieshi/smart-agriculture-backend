...
@RestController
@RequestMapping("/api/ai/pest")
public class AiPestController {

    private final PestService pestService;

    public AiPestController(PestService pestService) {
        this.pestService = pestService;
    }

    @PostMapping("/detect")
    @OperationLogRecord(type = "AI_PEST_DETECT", target = "ai_pest", detail = "AI害虫识别")
